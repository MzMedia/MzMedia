...
public class DefaultModbusHandler extends DefaultProductMessageHandler {
    public DefaultModbusHandler(ProductProtocolManager deviceComponentManager, IProductProtocol protocol, String scriptLang, String script, String codecType, ICodec codec) {
