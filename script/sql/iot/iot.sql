...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    INDEX `dev_user_index_device_id` (`device_id`) USING BTREE,
...
(
    `tenant_id`   bigint(20)                                              NOT NULL COMMENT '租户ID',
    `id`          bigint(20)                                              NOT NULL AUTO_INCREMENT COMMENT '设备监测信息ID',
...
(
    `tenant_id`    bigint(20)                                              NOT NULL COMMENT '租户ID',
    `id`           bigint(20)                                              NOT NULL AUTO_INCREMENT COMMENT '告警日志ID',
    `device_id`    bigint(20)                                              NULL DEFAULT NULL COMMENT '设备ID',
...
(
    `tenant_id`        bigint(20)                                             NOT NULL COMMENT '租户ID',
    `id`               bigint(20)                                             NOT NULL AUTO_INCREMENT COMMENT '场景触发器ID',
    ...
    `model_id`               varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '物模型标识符',
...
(
    `tenant_id`     bigint(20)                                              NOT NULL COMMENT '租户ID',
    `id`             bigint(20)                                              NOT NULL AUTO_INCREMENT COMMENT '物模型ID',
...
(
    ...
    codec_id         bigint(20)  not null comment '编解码器ID',
    ...
    state            varchar(30) not null comment '协议运行状态',
    del_flag         char(1)              default '0' comment '删除标志（0代表存在 2代表删除）',
    create_dept      bigint(20)           default null comment '创建部门',
    create_by        bigint(20)           default null comment '创建者',
    create_time      datetime comment '创建时间',
